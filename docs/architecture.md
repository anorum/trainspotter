...
A native read-only client of the public board: one-screen SwiftUI app, home/lock-screen widgets, a watch app with watch-face complications, and a Siri intent, all answering from `/api/v1/status`.
